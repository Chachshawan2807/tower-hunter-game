...
export const UI_I18N_STRINGS: Record<string, Record<Locale, string>> = {
  ...
  "tower.locked": { en: "locked", th: "ล็อก" },
  "tower.auto": { en: "Auto", th: "ออโต้" },
  "battle.equipped_skills": { en: "Equipped skills", th: "สกิลที่สวมใส่" },
  ...
  "skills.basic_attack.desc": {
    en: "Standard weapon strike with no MP cost",
    th: "โจมตีอาวุธปกติ ไม่ใช้ MP",
  },
  ...
  "skills.detail.type": { en: "Type", th: "ประเภท" },
  "skills.detail.target": { en: "Target", th: "เป้าหมาย" },
  "skills.detail.target_self": { en: "Self", th: "ตนเอง" },
  "skills.detail.target_enemy": { en: "Enemy", th: "ศัตรู" },
  "skills.detail.damage": { en: "Damage", th: "ดาเมจ" },
  "skills.detail.heal": { en: "Heal", th: "ฟื้น HP" },
  "skills.detail.def_pierce": { en: "DEF pierce", th: "ทะลุ DEF" },
  "skills.detail.status": { en: "Status", th: "สถานะ" },
  "skills.detail.self_status": { en: "Self buff", th: "บัฟตนเอง" },
  "skills.detail.turns": { en: " turns", th: " เทิร์น" },
  "skills.detail.gauge": { en: "Gauge", th: "เกจ" },
  "skills.detail.passive_label": { en: "Passive", th: "พาสซีฟ" },
  "skills.detail.passive_row": { en: "Equipped passive skills", th: "สกิลพาสซีฟที่สวม" },
  "skills.detail.info_short": { en: "i", th: "i" },
  "skills.detail.info_aria": {
