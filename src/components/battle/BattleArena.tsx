...
export const BattleArena = memo(function BattleArena({
  ...
  return (
    <div className="battle-arena" role="region" aria-label="Battle">
      <div className="battle-arena__frame">
        ...
        <div className="battle-entities">
          <div className="entity-card entity-card--player">
            <div className="entity-icon entity-icon--player" aria-hidden="true">
              🧙
            </div>
            <span className="entity-name">{t("battle.player", locale)}</span>
            <HpBar
              label="HP"
              hp={player.hp}
              maxHp={player.maxHp}
          ...
          <div className="entity-card entity-card--enemy">
            <div className="entity-icon entity-icon--enemy" aria-hidden="true">
              👹
            </div>
            <span className="entity-name">{t("battle.enemy", locale)}</span>
            <HpBar
              label="HP"
              hp={enemy.hp}
              maxHp={enemy.maxHp}
        ...
        {isComplete && result && (
          <div
            className={`result-banner result-banner--${result}`}
            role="status"
          >
        ...
        <div className="battle-actions" aria-label="Battle actions">
          ...
          {isComplete && !isPlaying && (
            <button className="action-btn" onClick={onReset} aria-label="Done">
              ✓
            </button>
          )}
        </div>
